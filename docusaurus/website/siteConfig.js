...
const siteConfig = {
  ...
  projectName: 'sko-public',
  organizationName: 'sikoba',
  ...
  headerLinks: [
    {doc: 'overview', label: 'Mobile App Docs'},
    {doc: 'web/start', label: 'Web App Docs'},
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Sikoba Ltd`,
